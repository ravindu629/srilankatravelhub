...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Sri Lanka Travel Hub - Rules and guidelines for using our website and services.",
};
    ...
    <div className="pt-24 pb-20">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-accent-600 py-16 mb-12">
        <div className="container-custom text-center text-white">
          ...
          <p className="text-xl">Last updated: December 31, 2025</p>
        </div>
      </div>
      ...
      <div className="container-custom max-w-4xl">
        <div className="bg-white rounded-xl shadow-md p-8 md:p-12 prose prose-lg max-w-none">
          ...
          <p>
            Welcome to Sri Lanka Travel Hub ("Company," "we," "our," or "us").
            These Terms of Service ("Terms") govern your access to and use of
            our website located at srilankatravelhub.com (the "Website").
          </p>
          <p>
          ...
          <h3>Permitted Use</h3>
          <p>
            You may use our Website for lawful purposes only. You agree to use
            our Website in accordance with these Terms and all applicable laws
            and regulations.
          </p>
          ...
          <p>
            ...
            displays, images, video, and audio) are owned by Sri Lanka Travel
            Hub, its licensors, or other providers of such material and are
          ...
          <ul>
            <li>
              View and access content on the Website for your personal,
              non-commercial use
            </li>
            <li>Share links to our blog posts and pages on social media</li>
            <li>
              Quote short excerpts from our articles with proper attribution
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              transmit any of the material on our Website, except as permitted
              above
            </li>
            <li>
              Copy or reproduce our articles, photos, or content without written
              permission
            </li>
            <li>
          ...
          <p>
            When you submit content through our contact forms, comments, or
            other features (collectively, "User Content"), you grant us a
            non-exclusive, worldwide, royalty-free, perpetual license to use,
            reproduce, modify, adapt, publish, translate, create derivative
            works from, and display such content.
          </p>
          ...
          <ul>
            ...
            <li>
              Your User Content does not contain offensive, defamatory, or
              illegal material
            </li>
          </ul>
          ...
          <p>
            ...
            that are not owned or controlled by Sri Lanka Travel Hub. We have no
          ...
          <p>
            ...
            We make no warranties, expressed or implied, regarding the Website,
            including:
          </p>
          <ul>
          ...
          <p>
            <strong>Important:</strong> All travel information, recommendations,
            and advice on this Website are for general informational purposes
            only. We make no guarantees about:
          </p>
          <ul>
            <li>The accuracy of travel information, prices, or availability</li>
            <li>
              Current travel restrictions, visa requirements, or health
              recommendations
            </li>
          ...
          <p>
            Always verify information with official sources, embassies, tour
            operators, and local authorities before making travel decisions.
            Travel conditions can change rapidly.
          </p>

          <h2>Limitation of Liability</h2>
          <p>
            TO THE FULLEST EXTENT PERMITTED BY LAW, SRI LANKA TRAVEL HUB SHALL
            NOT BE LIABLE FOR:
          </p>
          <ul>
            <li>
            ...
            <li>
              Any damages arising from travel decisions made based on Website
              content
            </li>
          </ul>
          <p>
          ...
          <p>
            You agree to defend, indemnify, and hold harmless Sri Lanka Travel
            Hub and its officers, directors, employees, and agents from and
          ...
          <p>
            Our Website may contain affiliate links. This means we may earn a
            commission if you click through and make a purchase, at no
            additional cost to you. We only recommend products and services we
          ...
          <p>
            ...
            Please review our <a href="/privacy">Privacy Policy</a> to
          ...
          <p>
            Any dispute arising from these Terms or your use of the Website will
            be resolved through:
          </p>
          <ol>
            <li>
              <strong>Informal Negotiation:</strong> Contact us first to resolve
              the issue informally
            </li>
            <li>
              <strong>Mediation:</strong> If informal negotiation fails, we
          ...
          <p>
            These Terms constitute the entire agreement between you and Sri
            Lanka Travel Hub regarding your use of the Website and supersede all
          ...
          <ul>
            ...
            <li>
              ...
              <a href="/contact">srilankatravelhub.com/contact</a>
            </li>
          </ul>

          <h2>Acknowledgment</h2>
          <p>
            BY USING OUR WEBSITE, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS
          ...
          <div className="bg-accent-50 border-l-4 border-accent-600 p-6 rounded-r-lg mt-8">
            <p className="text-sm text-neutral-700 mb-0">
              <strong>Note:</strong> These terms were last updated on December
              31, 2025. We recommend reviewing these terms periodically for any
              changes.
            </p>
          </div>
        </div>
