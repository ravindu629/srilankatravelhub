...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for Sri Lanka Travel Hub - How we collect, use, and protect your personal information.",
};
    ...
    <div className="pt-24 pb-20">
      ...
      <div className="container-custom max-w-4xl">
        <div className="bg-white rounded-xl shadow-md p-8 md:p-12 prose prose-lg max-w-none">
          <h2>Introduction</h2>
          <p>
            Welcome to Sri Lanka Travel Hub ("we," "our," or "us"). We are
            committed to protecting your personal information and your right to
            privacy. This Privacy Policy explains how we collect, use, disclose,
            and safeguard your information when you visit our website
            srilankatravelhub.com.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              <strong>Email Address:</strong> Your email for communication
            </li>
            <li>
              <strong>Contact Information:</strong> Subject and message content
              from contact forms
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              send you newsletters (if subscribed)
            </li>
            <li>
              <strong>Improve Our Website:</strong> To understand how visitors
              use our site and improve user experience
            </li>
            <li>
              <strong>Analytics:</strong> To analyze usage patterns and optimize
              content
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <strong>Withdraw Consent:</strong> Withdraw consent for newsletter
          ...
          <p>
            ...
            to send you updates about Sri Lankan travel, destinations, and tips.
          ...
          <p>
            ...
            using our website, you consent to the transfer of your information
            to our facilities and service providers.
          </p>
          ...
          <div className="bg-primary-50 border-l-4 border-primary-600 p-6 rounded-r-lg mt-8">
            <p className="text-sm text-neutral-700 mb-0">
              ...
              December 31, 2025. Please check back regularly for any updates or
