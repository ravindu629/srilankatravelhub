...
**First time in Sri Lanka?** Complete your travel preparation with our [Ultimate Sri Lanka Travel Guide 2026](https://www.srilankatravelhub.com/blog/blog-1-ultimate-sri-lanka-travel-guide-2026) for comprehensive destination planning, and check your [Sri Lanka Visa Guide 2026](https://www.srilankatravelhub.com/blog/blog-5-sri-lanka-visa-guide) to ensure your travel documents are ready.

![International airport terminal in Sri Lanka](https://images.unsplash.com/photo-1620146596504-95527348e0ac?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)
...
![Airport arrival hall with travelers](https://images.unsplash.com/photo-1573076978602-a16914734d61?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)
...
5. Provide hotel address for delivery
  ...
  <table style="width: 100%; border-collapse: separate; border-spacing: 15px 10px;">
    <thead>
      <tr style="background-color: #f8f9fa;">
        <th style="padding: 15px; text-align: left; min-width: 120px;"><strong>Provider</strong></th>
        <th style="padding: 15px; text-align: left; min-width: 150px;"><strong>Data Package</strong></th>
        <th style="padding: 15px; text-align: left; min-width: 100px;"><strong>Cost (USD)</strong></th>
        <th style="padding: 15px; text-align: left; min-width: 200px;"><strong>Best For</strong></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style="padding: 12px;"><strong>Dialog</strong></td>
        <td style="padding: 12px;">10GB + calls</td>
        <td style="padding: 12px;">$7-10</td>
        <td style="padding: 12px;">Best coverage nationwide</td>
      </tr>
      <tr style="background-color: #f8f9fa;">
        <td style="padding: 12px;"><strong>Mobitel</strong></td>
        <td style="padding: 12px;">15GB + calls</td>
        <td style="padding: 12px;">$10-12</td>
        <td style="padding: 12px;">Good speeds, reliable</td>
      </tr>
      <tr>
        <td style="padding: 12px;"><strong>Airtel</strong></td>
        <td style="padding: 12px;">20GB + calls</td>
        <td style="padding: 12px;">$8-10</td>
        <td style="padding: 12px;">Most data for price</td>
      </tr>
    </tbody>
  </table>
</div>
...
1. **Go to counter** (Dialog recommended)
2. **Show passport** (required for registration)
3. **Choose package**
...
4. Carry mix of bills (small denominations useful)

**Budget planning:** Check our [Sri Lanka Travel Cost Guide 2026](https://www.srilankatravelhub.com/blog/blog-3-srilanka-travel-costs) for complete budget breakdown and daily expense estimates.
...
<div style="overflow-x: auto; margin: 20px 0;">
  <table style="width: 100%; border-collapse: separate; border-spacing: 15px 10px;">
    <thead>
      <tr style="background-color: #f8f9fa;">
        <th style="padding: 15px; text-align: left; min-width: 180px;"><strong>Destination</strong></th>
        <th style="padding: 15px; text-align: left; min-width: 120px;"><strong>Distance</strong></th>
        <th style="padding: 15px; text-align: left; min-width: 150px;"><strong>Travel Time</strong></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style="padding: 12px;">Colombo City Center</td>
        <td style="padding: 12px;">35 km</td>
        <td style="padding: 12px;">45-90 mins</td>
      </tr>
      <tr style="background-color: #f8f9fa;">
        <td style="padding: 12px;">Negombo (Beach)</td>
        <td style="padding: 12px;">10 km</td>
        <td style="padding: 12px;">15-25 mins</td>
      </tr>
      <tr>
        <td style="padding: 12px;">Kandy</td>
        <td style="padding: 12px;">130 km</td>
        <td style="padding: 12px;">3-4 hours</td>
      </tr>
      <tr style="background-color: #f8f9fa;">
        <td style="padding: 12px;">Galle</td>
        <td style="padding: 12px;">150 km</td>
        <td style="padding: 12px;">2.5-3.5 hours</td>
      </tr>
      <tr>
        <td style="padding: 12px;">Sigiriya</td>
        <td style="padding: 12px;">165 km</td>
        <td style="padding: 12px;">3.5-4.5 hours</td>
      </tr>
    </tbody>
  </table>
</div>
...
4. Receive voucher with taxi number
5. Exit airport
6. Find your taxi (staff help you)
7. Give voucher to driver
...
3. Open PickMe app
4. Enter destination
5. Confirm pickup point (follow airport signs for ride-hailing area)
6. Book ride
7. Driver arrives (5-15 minutes)
8. Show driver your name/booking
9. Enjoy ride
...
**Route:**
Airport → Colombo city (various stops)
...
4. **Trincomalee Airport** - East coast
5. **Jaffna Airport** - Northern Sri Lanka
6. **Koggala Airport** - South coast
...
**Complete planning:** See our [Ultimate Sri Lanka Travel Guide 2026](https://www.srilankatravelhub.com/blog/blog-1-ultimate-sri-lanka-travel-guide-2026) for detailed itineraries and destination information.
...
✅ Read [Ultimate Sri Lanka Travel Guide 2026](https://www.srilankatravelhub.com/blog/blog-1-ultimate-sri-lanka-travel-guide-2026)

**3. Choose the right time:**  
✅ Check [Best Time to Visit Sri Lanka 2026](https://www.srilankatravelhub.com/blog/blog-2-best-time-to-visit)
